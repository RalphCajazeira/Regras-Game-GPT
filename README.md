...
- [`docs/04-integracao-gpt-backend.md`](docs/04-integracao-gpt-backend.md): snapshots, sessões versionadas, criação de instâncias, revisão e persistência.
...
Os documentos representam uma especificação em evolução. Fórmulas, tempos, multiplicadores, preços, custos, limiares, pilhas, carga e durabilidade devem ser simulados antes de versões `v1.0`.
