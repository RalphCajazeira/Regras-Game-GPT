...
O GPT interpreta as decisões do jogador, conduz a narrativa e resolve o combate usando regras e fichas carregadas. O backend evita perda de estado, valida resultados, persiste alterações e executa consequências autoritativas, sem precisar ser chamado para cada microetapa do combate.
...
- [`docs/03-sistema-de-equipamentos.md`](docs/03-sistema-de-equipamentos.md): estrutura universal, slots, qualidade, orçamento de pontos, penalidades, peso e preço.
...
Os documentos representam uma especificação inicial em evolução. Fórmulas e multiplicadores devem ser versionados e validados por simulações antes de serem tratados como definitivos.
...
- O GPT não inventa campos mecânicos ausentes.
