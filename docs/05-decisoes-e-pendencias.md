...
- Combate, comércio, perícias e fabricação não exigem chamada a cada microação.
...
## 4. Pendências de combate e ações
...
## 7. Pendências de perícias e profissões
...
## 9. Pendências de progressão geral
...
## 10. Próximas validações

1. Criar Guerreiro, Gatuno, Arqueiro, Mago e híbrido com o mesmo orçamento.
2. Testar os cinco atributos nos níveis 1, 5, 10, 20 e 50.
3. Simular combate temporal e medir duração, acerto e frequência de ações.
4. Simular Comércio com passivas e limites de preço.
5. Simular Ferraria em receitas triviais, equivalentes e difíceis.
6. Medir sucesso, qualidade, consumo e XP.
7. Ajustar antes de publicar versões `v1.0`.
